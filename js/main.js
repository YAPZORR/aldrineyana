...
scrollableContent.addEventListener('mousedown', function(event) {
  ...
  startScrollPosition = scrollableContent.scrollTop;
});
...
scrollableContent.addEventListener('mousemove', function(event) {
  ...
  scrollableContent.scrollTop = startScrollPosition - deltaY;
});
...
var php = function(){
  ...
  var fig = function(){
    document.querySelector(".figma").className = "figma1";  
    };
    var edit = function(){
        document.querySelector(".edit").className = "edit1";  
        };
  setTimeout(php,100);
  setTimeout(css,200);
  setTimeout(htm,400);
  ...
  document.getElementById('contact-form').addEventListener('submit', function (event) {
    ...
    // Generate mailto URL
    var mailtoUrl = 'mailto:aldrineyana1@gmail.com' + '?subject=' + encodeURIComponent(subject) + '&body=' + encodeURIComponent(body);
